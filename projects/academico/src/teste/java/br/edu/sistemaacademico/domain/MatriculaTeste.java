...
class MatriculaTest {
    ...
    void deveCancelarMatricula() {
        // Arrange
        var aluno = new Aluno("RA001", "Kaliria Meline", "nunes.kaliria@gmail.com");
    ...
    void deveTrancarMatricula() {
        // Arrange
        var aluno = new Aluno("RA002", "Nunes kaliria", "kaliria@gmail.com");
        var turma = new Turma("ESOFT4S-NA", new Disciplina("POO", "Programação Orientada a Objetos", 80), new PeriodoLetivo(2026, Semestre.SEGUNDO));
        var matricula = turma.getOfertas().get(0).matricular(aluno);
    ...
    void deveConcluirMatriculaAprovacao() {
        // Arrange
        var aluno = new Aluno("RA001", "Kaliria Meline", "Kaliria@gmail.com");
        var turma = new Turma("ESOFT4S-NA", new Disciplina("POO", "Programação Orientada a Objetos", 80), new PeriodoLetivo(2026, Semestre.SEGUNDO));
        var matricula = turma.getOfertas().get(0).matricular(aluno);
    ...
    void deveImpedirConcluirMatriculaJaConcluida() {
        // Arrange
        var aluno = new Aluno("RA005", "Kaliria Meline", "nunes.kaliria@gmail.com");
        var turma = new Turma( "ESOFT4S-NA", new Disciplina("POO", "Programação Orientada a Objetos", 80), new PeriodoLetivo(2026, Semestre.SEGUNDO) );
    ...
    void deveImpedirConcluirMatriculaTrancada() {
        // Arrange
        var aluno = new Aluno("RA004", "Nunes Kaliria", "kaliria@gmail.com");
        var turma = new Turma( "ESOFT4S-NA", new Disciplina("POO", "Programação Orientada a Objetos", 80), new PeriodoLetivo(2026, Semestre.SEGUNDO) );
    ...
    void deveAceitarCodigoComEspacos() {
        //Arrange
        var aluno = new Aluno("RA003", "Nunes Kaliria", "kaliria@gmail.com");
        var turma = new Turma( "ESOFT4S-NA", new Disciplina("POO", "Programação Orientada a Objetos", 80), new PeriodoLetivo(2026, Semestre.SEGUNDO) );
        // Act
    ...
    void deveCriarMatriculaUsandoTurma() {
        // Arrange
        var aluno = new Aluno("RA004", "Kaliria Meline", "nunes.kaliria@gmail.com");
        var turma = new Turma( "ESOFT4S-NA", new Disciplina("POO", "Programação Orientada a Objetos", 80), new PeriodoLetivo(2026, Semestre.SEGUNDO) );
