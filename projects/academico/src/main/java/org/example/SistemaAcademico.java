...
public class SistemaAcademico {
    ...
    public static void main(String[] args) {
        ...
        var notaProva = scanner.nextDouble();

        System.out.print("Digite a nota do Projeto: ");
        var notaProjeto = scanner.nextDouble();

        System.out.print("Digite a nota da Lista: ");
        var notaLista = scanner.nextDouble();

        System.out.print("Digite o total de faltas: ");
        var totalFaltas = scanner.nextInt();
