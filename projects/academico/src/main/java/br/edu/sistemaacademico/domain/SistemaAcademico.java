...
public class SistemaAcademico {
    ...
    public static void main(String[] args) {
        ...
        var primeiraMatricula = poo2025.matricular("MAT-2025-001", paola);
        ...
        var segundaMatricula = poo2026A.matricular("MAT-2026-001", paola);
        ...
        esperarFalha(
                ...
                () -> poo2026B.matricular("MAT-2026-002", paola)
        );

        System.out.println();
        System.out.println("=== MATRÍCULA DUPLICADA ===");

        var matriculaBruno = poo2026A.matricular("MAT-2026-003", bruno);

        esperarFalha(
                "Aluno não pode possuir duas matrículas na mesma oferta.",
                () -> poo2026A.matricular("MAT-2026-004", bruno)
        );
